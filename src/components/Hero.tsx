...
export default function HeroSection() {
  return (
    ...
    className="custom-height max-w-6xl mx-auto py-28 flex flex-col items-center justify-center text-center px-4 bg-gray-50 dark:bg-gray-900 bg-hero bg-cover bg-center bg-no-repeat hero-overlay">
      ...
      <motion.div
        className="text-xl md:text-2xl font-semibold text-muted-foreground mb-6 min-h-[40px] flex justify-center"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <motion.a
        href="/resume.pdf"
        download
        className="inline-flex items-center border-4 text-white px-6 py-3 rounded-full shadow hover:bg-primary/90 transition"
