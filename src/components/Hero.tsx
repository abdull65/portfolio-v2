...
export default function HeroSection() {
  return (
    ...
    className="custom-height max-w-6xl mx-auto py-28 flex flex-col items-center justify-center text-center px-4 bg-gray-50 dark:bg-gray-900 bg-hero bg-cover bg-center bg-no-repeat hero-overlay">
      ...
      <motion.a
        href="/cv"
        className="inline-flex items-center border-2 border-gray-800 dark:border-gray-100 text-xl text-gray-800 dark:text-gray-100 px-6 py-3 rounded-full shadow hover:bg-primary/90 transition"
